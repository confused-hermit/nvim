...
local sumneko_binary = "/home/" .. USER .. "/.config/nvim/ls/lua-language-server/bin/".. system_name .. "/lua-language-server"
...
local langservers = {'html', 'cssls', 'ls_emmet', 'tsserver', 'pyright', 'sumneko_lua', 'rust_analyzer', 'gopls', 'texlab'}
